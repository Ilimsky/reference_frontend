...
import 'package:reference_frontend/models/User.dart';
import '../models/UserDepartmentBinding.dart';
import '../service/auth_service.dart';

class EditUserDialog extends StatefulWidget {
  final User user;
  final UserDepartmentBinding binding;

  const EditUserDialog({super.key, required this.user, required this.binding});
...
class _EditUserDialogState extends State<EditUserDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final canEditUsername = isSuperAdmin ||
        (isAdmin && !widget.user.roles.contains('ROLE_SUPERADMIN') && !widget.user.roles.contains('ROLE_ADMIN'));
